...
def _get_margins(self, target_margin: float = 0):
    ...
    pred = tfunc.softmax(self._model(self._specific_inputs), dim=1).cpu()
...
def main():
    ...
    results_dir = os.path.join(os.path.dirname(__file__), "../benchmark_results/retrain_strong_class_stop_cond/")
    ...
    for target_margin in target_margins:
        ...
        this_get_margins = partialmethod(_get_margins, target_margin=target_margin)
        Retrainer._get_margins = this_get_margins

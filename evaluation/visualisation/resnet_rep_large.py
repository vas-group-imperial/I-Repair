...
if __name__ == '__main__':
    ...
    result_dirs = ["../benchmark_results/resnet_large_retrain/",
                   "../benchmark_results/resnet_large_repair_edge_0.001/",
                   "../benchmark_results/resnet_large_repair_edge_0.01/",
                   "../benchmark_results/resnet_large_repair_edge_0.05/",
                   "../benchmark_results/resnet_large_repair_edge_0.1/",
                   "../benchmark_results/resnet_large_repair_edge_0.5/",
                   "../benchmark_results/resnet_large_repair_edge_1/",
                   "../benchmark_results/resnet_large_repair_edge_2/"
                   ]
    ...
    plt.legend(['Retraing', 'Gamma=0.001', 'Gamma=0.01', 'Gamma=0.05', 'Gamma=0.1', 'Gamma=0.5', 'Gamma=1', 'Gamma=2'])

...
class ResNet(nn.Module):
    ...
    def _init_dataloaders(self, num_train: int = 49000, data_dir: str = '../../resources/MNIST/'):
        ...
        train_dset = datasets.MNIST(root=data_dir, train=True, transform=train_trans, download=False)
        val_dset = datasets.MNIST(root=data_dir, train=True, transform=val_trans, download=False)
    ...
    def save(self, path: str = "../../resources/models/mnist_resnet.pth"):
